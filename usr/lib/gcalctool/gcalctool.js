...
function GCalcTool() {
	...
	this.container = $.w.container().addClass('gcalctool');
	
	this.textarea = $.w.textAreaEntry();
	...
	this.window.window('content').append(this.container);
